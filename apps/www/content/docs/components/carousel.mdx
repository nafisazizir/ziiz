...
```bash
npx shadcn@latest add @ziiz/carousel
```
...
```bash
npm install @hugeicons/core-free-icons @hugeicons/react embla-carousel-react
```

<Step>Copy and paste the following code into your project.</Step>

<RegistrySource name="carousel" />
...
Both render a [`Button`](/components/button) and accept all of its props.

| Prop      | Type                     | Default     |
| --------- | ------------------------ | ----------- |
| `variant` | `Button["variant"]`      | `"outline"` |
| `size`    | `Button["size"]`         | `"icon-sm"` |
| `shape`   | `"default" \| "rounded"` | `"rounded"` |
