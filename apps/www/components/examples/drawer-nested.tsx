    ...
    <Drawer showSwipeHandle={isMobile} swipeDirection={swipeDirection}>
      ...
      <DrawerContent>
        ...
        <div className="flex-1 p-4">
          <div className="bg-gray-100 group-data-[swipe-axis=x]/drawer-popup:size-full group-data-[swipe-axis=y]/drawer-popup:aspect-video group-data-[swipe-axis=y]/drawer-popup:w-full" />
        </div>
        <DrawerFooter>
          <Drawer showSwipeHandle={isMobile} swipeDirection={swipeDirection}>
