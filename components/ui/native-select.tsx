  ...
  return (
    ...
    >
      <select
        ...
        {...props}
      />
      <HugeiconsIcon icon={UnfoldMoreIcon} strokeWidth={2} className="pointer-events-none absolute top-1/2 right-2.5 size-4 -translate-y-1/2 text-gray-900 select-none" aria-hidden="true" data-slot="native-select-icon" />
    </div>
  )
}
