...
description: Migrate a components/ui file from stock shadcn (Vega) to the ziiz foundations system, with ramp colors, type roles, materials, focus signatures. Use when asked to migrate a component, run a migration pass, or continue the shadcn → ziiz migration.
---
