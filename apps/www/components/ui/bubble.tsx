...
function BubbleContent({
  ...
  return useRender({
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          "w-fit max-w-full min-w-0 overflow-hidden rounded-xl border border-transparent px-3 py-2 text-copy-14 wrap-break-word group-data-[align=end]/bubble:self-end [button]:text-left [button,a]:transition-colors [button,a]:outline-none [button,a]:focus-visible:border-gray-600 [button,a]:focus-visible:ring-3 [button,a]:focus-visible:ring-gray-600/50",
          className
        ),
      },
      props
...
const bubbleReactionsVariants = cva(
  "absolute z-10 flex w-fit shrink-0 items-center justify-center gap-1 rounded-full bg-gray-100 px-1.5 py-0.5 text-label-14 ring-3 ring-background-100 has-[button]:p-0",
  {
    variants: {
      side: {
