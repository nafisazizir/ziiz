...
<ComponentPreview name="field-demo" previewClassName="p-6" />
...
```bash
npx shadcn@latest add @ziiz/field
```
...
<ComponentPreview name="field-responsive" previewClassName="p-6 md:p-10" />
